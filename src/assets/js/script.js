...
$(document).ready(responsivenessFix);
$(document).ready(function() {
...
$(window).resize(function(){
    const navBarRef = $("nav[pcoded-header-position='fixed']");
    if (navBarRef.hasClass('opened') && window.innerWidth > 600) {
        navBarRef.toggleClass('opened');
    }
});
